...
static char *history[MAX_HISTORY];  // 历史记录数组
static int history_count = 0;       // 当前历史记录数
static int history_index = -1;      // 当前浏览的历史记录索引
static char temp_buffer[MAX_CMD_LEN]; // 临时缓冲区，用于保存当前输入
