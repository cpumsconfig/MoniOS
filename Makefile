OBJS = out/kernel.o out/common.o out/monitor.o out/main.o out/gdtidt.o out/nasmfunc.o out/isr.o out/interrupt.o \
	 ...
	 out/shutdown.o  out/net.o out/network.o out/screen.o

LIBC_OBJECTS = out/syscall_impl.o out/stdio.o out/string.o out/malloc.o out/time.o 
...
run : hd.img
	qemu-system-i386 -hda hd.img -net nic,model=ne2k_pci,macaddr=52:54:00:12:34:56 -net user
